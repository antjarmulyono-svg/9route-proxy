...
function normalizeProxyPoolUpdate(body = {}) {
  ...
  if (Object.prototype.hasOwnProperty.call(body, "proxyUrl")) {
    ...
    if (!body.type) {
      if (proxyUrl.includes(".workers.dev")) updates.type = "cloudflare";
      else if (proxyUrl.includes(".vercel.app")) updates.type = "vercel";
      else if (proxyUrl.includes(".deno.dev")) updates.type = "deno";
    }
  }
