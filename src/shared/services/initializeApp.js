...
import { getMitmStatus, startMitm, loadEncryptedPassword, initDbHooks, restoreToolDNS, removeAllDNSEntriesSync, isSudoAvailable } from "@/mitm/manager";
...
async function autoStartMitm(settings) {
  ...
  try {
    ...
    const needsPassword = process.platform !== "win32" && isSudoAvailable();
